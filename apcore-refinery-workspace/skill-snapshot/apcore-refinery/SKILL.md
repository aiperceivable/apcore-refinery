...
description: >
  Apcore refinery dashboard for *-apcore projects. Shows project summary, module
  count, average metadata quality score, and available commands. Use this when the
  user invokes /apcore-refinery with no subcommand, or wants an overview of their
  *-apcore project's metadata health.
---
